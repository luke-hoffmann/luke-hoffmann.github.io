...
I have started working more consistently. Each day I usually do the following:
- Ensure that the shop is clean
- Teach people how to use tools such as 
  - Table saws
  - Chop saws
  - Band saws
  - Drill presses
  - Sanders
- Myself learn how to better use tools
Some shifts I will be working closing, so we ensure that the shop is fully clean for the next day. Alot of sweeping and cleaning (I really enjoy it; probably because of all the time I spent sweeping and cleaning with Dad on job sites).

One of my bosses (Taylor), loves to bicycle. He rides a cool looking bike to work everyday. The bike looks like its made to carry packages, it has a enclosed area that he says his girlfriend is able to fit in, and they can ride around town. One day that was slow, he used the metal lathe to create a bicycle stem cap. Made out of bronze or brass it looked sweet.

--- 

People have consistently seen me in action, whether it be chatting with a group of people for the first time, designing things for creation, or me actually making a hands on project happen. People have commented (probably 4-5 times) that they are surprised I am a math major. People have said that I should be:
- An architechural engineering major
- A sales major
- A mechanichal engineering major
This again is interesting to have people recognize some of my skills in certain areas, and makes me aware that I am capable of tasks in many different fields.

Its interesting for me to take a step back and think about who I am, the skills I have, how my family and upbringing caused me to be this way
Here is a list of things that I believe I know how to do:
- understand how things work/behave
- utilize materials and other elements effectively
- utilize tools
- communicate with a wide variety of people (I think serving ice cream this summer helped with this)
- empathize with people in different situations
- understand what needs to happen, while having the skills to make it happen
- listen to people

I appreciate everyones involvement in my upbringing, and I am very grateful for how everyone grew me into who I am.
...
My dorm floor is very active, very social. Every night something is happens, for better or for worse. While I was gone this last weekend (backpacking in big sur; keep reading to hear about it), apparently a fight broke out on my floor (I am not familiar with the involved parties).

People always leaves their doors open, and I roam around and hangout with my friends.
...
I am in a club called: "Design Build Fly." The goal is to design a remote controlled aircraft, build it, and then compete it in an international competition. Everything is done from scratch and here is an overview:

- The flight sciences team utilizes software to generate a stable lightweight aircraft design. They use different techniques to model how the aircraft will behave.
- The structures team (with I am apart of) takes the "net shape" aircraft design, and creates the structures required to achieve a rigid airframe, while staying light enough.
- The competition involves different events where our aircraft is tested. The aircraft has to be able to carry a payload (2L soda bottles).

Part of the building process is to test the "net shape" of the aircraft.
- Building the whole airplane out of balsa wood with the final design isnt efficient when its a test
- We use a computer controlled hot wire foam cutter to cut the shape of the aircraft out of foam. This is used for aerodynamic testing
- The foam cutter was in need of help, so I created a platform for it to sit on. Its a very simple design, but here it is:
  - I used 4 - 2x4s to create a structure
  - I used half lap joints in to connect the 2x4s in a flat configuration
  - I suggested that we add leveling feet so that we can make sure the foam cutter is level, so its accurate.
    - A nut is pressed into some plywood, so its help captive
    - Then a bolt is screwed into the nut and can be screwed in or out to level the structure
...
Lots of my friends who are girls recently rushed into the sororities
- Its interesting, sad and funny how the system is
  - Girls go around to all of the sorority houses and spend hours on hours (while hungry and exhausted) talking to different girls, trying to make a lasting impression
  - Then each sorority goes through pictures of the girls, and if they remember and liked the girls, then they move to the next stage
  - Its amazing how much theatrics and drama this causes, just to live in a house with some girls
  - Just interesting to be friends with people who rushed, and to hear their perspective
Guys are rushing now, and its similar, but they dont seem as affected (hard to tell if they are being nonchalant, or actually dont care)


---


**Backpacking in Big Sur was pretty sweet**


I joined a club called "Field Studies." We do just that. We go out into nature and study it, more realistically we just enjoy the outdoors.

This last weekend I went on a backpacking trip to Big Sur with a group of ten.
...
The slats slide into those grooves, and can be removed and placed elsewhere. So it can be reorganized.
